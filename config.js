const nameGirl = 'Duy Thịnh';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng Sinh Nhật Em Yêu';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc ebee của anh sinh nhật tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
